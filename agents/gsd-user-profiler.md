...
<reference>
@/home/tony/.config/opencode/gsd-core/references/user-profiling.md
...
Read the user-profiling reference document at `/home/tony/.config/opencode/gsd-core/references/user-profiling.md` to load:
