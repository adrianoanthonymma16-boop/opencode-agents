...
Reference full template: `/home/tony/.config/opencode/gsd-core/templates/roadmap.md`

## STATE.md Structure

Use template from `/home/tony/.config/opencode/gsd-core/templates/state.md`.
