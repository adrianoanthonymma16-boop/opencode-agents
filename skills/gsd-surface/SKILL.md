...
<objective>
Manage the runtime skill surface without reinstall. Reads/writes `/home/tony/.config/opencode/.gsd-surface.json`
(sibling to `/home/tony/.config/opencode/.gsd-profile`) and re-stages the active skills directory in place.
Skill dirs live at `/home/tony/.config/opencode/skills/gsd-*/`.
...
(`~/.config/opencode`), NOT the skills sub-directory (`/home/tony/.config/opencode/skills`).
...
`/home/tony/.config/opencode/skills/gsd-*/` because the `claude global` layout has `destSubpath =
...
(i.e. `/home/tony/.config/opencode/.gsd-surface.json`).
...
<execution_context>
Surface state file: `/home/tony/.config/opencode/.gsd-surface.json`
Install profile marker: `/home/tony/.config/opencode/.gsd-profile`
Skill dirs: `/home/tony/.config/opencode/skills/gsd-*/`
Engine module: `/home/tony/.config/opencode/gsd-core/bin/lib/surface.cjs`
Cluster definitions: `/home/tony/.config/opencode/gsd-core/bin/lib/clusters.cjs`
</execution_context>
