...
<required_reading>
@/home/tony/.config/opencode/gsd-core/references/user-story-template.md
@/home/tony/.config/opencode/gsd-core/references/spidr-splitting.md
@/home/tony/.config/opencode/gsd-core/references/planner-mvp-mode.md
</required_reading>
...
Normalize per `@/home/tony/.config/opencode/gsd-core/references/phase-argument-parsing.md` (zero-pad integer phases to two digits).
...
Run three sequential `question` calls. Each is free-text. After all three, assemble into the canonical sentence per `@/home/tony/.config/opencode/gsd-core/references/user-story-template.md`:
...
Run the SPIDR rules from `@/home/tony/.config/opencode/gsd-core/references/spidr-splitting.md`. Briefly:
