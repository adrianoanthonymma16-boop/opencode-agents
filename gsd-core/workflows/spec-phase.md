...
ones). Reference: @/home/tony/.config/opencode/gsd-core/references/edge-probe.md.
...
# — NOT the consuming project's git root — falling back to git toplevel / /home/tony/.config/opencode.
...
EDGE_PROBE_JS=$(for _c in \
  ...
  "/home/tony/.config/opencode/gsd-core/bin/lib/edge-probe.cjs" \
  "/home/tony/.config/opencode/bin/lib/edge-probe.cjs"; do
  [ -f "$_c" ] && { echo "$_c"; break; }
done)
...
requirement list). Reference: @/home/tony/.config/opencode/gsd-core/references/prohibition-probe.md — the
...
Use the SPEC.md template from @/home/tony/.config/opencode/gsd-core/templates/spec.md.
