...
```markdown
Read /home/tony/.config/opencode/agents/gsd-ui-researcher.md for instructions.
...
Template: /home/tony/.config/opencode/gsd-core/templates/UI-SPEC.md
</output>
...
```markdown
Read /home/tony/.config/opencode/agents/gsd-ui-checker.md for instructions.
...
@/home/tony/.config/opencode/gsd-core/references/ui-consideration-probe.md.
...
# (#448) — NOT the consuming project's git root — falling back to git toplevel / /home/tony/.config/opencode.
...
UI_PROBE_JS=$(for _c in \
  ...
  "/home/tony/.config/opencode/gsd-core/bin/lib/ui-consideration-probe.cjs" \
  "/home/tony/.config/opencode/bin/lib/ui-consideration-probe.cjs"; do
  [ -f "$_c" ] && { echo "$_c"; break; }
done)
