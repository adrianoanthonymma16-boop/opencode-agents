...
- **Global scope**: `/home/tony/.config/opencode/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `/home/tony/.config/opencode/notes/`)
...
2. Glob `/home/tony/.config/opencode/notes/*.md` (if directory exists) — global notes
...
Global (/home/tony/.config/opencode/notes/):
...
2. **No `.planning/`**: Falls back to global `/home/tony/.config/opencode/notes/` — works in any directory
