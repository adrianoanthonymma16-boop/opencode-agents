...
Key references:
- @/home/tony/.config/opencode/gsd-core/references/ui-brand.md (display patterns)
- @/home/tony/.config/opencode/agents/gsd-user-profiler.md (profiler agent definition)
- @/home/tony/.config/opencode/gsd-core/references/user-profiling.md (profiling reference doc)
</required_reading>
...
```bash
PROFILE_PATH="/home/tony/.config/opencode/gsd-core/USER-PROFILE.md"
...
```bash
cp "/home/tony/.config/opencode/gsd-core/USER-PROFILE.md" "/home/tony/.config/opencode/USER-PROFILE.backup.md"
```
...
✓ Stores profile at /home/tony/.config/opencode/gsd-core/USER-PROFILE.md
...
- The user-profiling reference doc at `/home/tony/.config/opencode/gsd-core/references/user-profiling.md`
...
Reference: @/home/tony/.config/opencode/gsd-core/references/user-profiling.md
...
Display: "✓ Profile written to /home/tony/.config/opencode/gsd-core/USER-PROFILE.md"
...
- options (ALL pre-selected by default):
  ...
  - "Global AGENTS.md" -- "Add profile to /home/tony/.config/opencode/AGENTS.md for all projects"

**If no artifacts selected:** Display "No artifacts generated. Your profile is saved at /home/tony/.config/opencode/gsd-core/USER-PROFILE.md" and jump to step 10.
...
Display: "✓ Generated /gsd-dev-preferences at /home/tony/.config/opencode/skills/gsd-dev-preferences/SKILL.md"
...
Display: "✓ Added profile section to /home/tony/.config/opencode/AGENTS.md"
...
```bash
BACKUP_PATH="/home/tony/.config/opencode/USER-PROFILE.backup.md"
```
...
Your profile:    /home/tony/.config/opencode/gsd-core/USER-PROFILE.md
```

Then list paths for each generated artifact:
```
Artifacts:
  ✓ /gsd-dev-preferences   /home/tony/.config/opencode/skills/gsd-dev-preferences/SKILL.md
  ✓ AGENTS.md section       <resolved claude_md_path, default ./.opencode/AGENTS.md>
  ✓ Global AGENTS.md        /home/tony/.config/opencode/AGENTS.md
```
