...
Check code says:  hooksDir = path.join(configDir, 'hooks')
                  configDir = /home/tony/.config/opencode
                  → checks /home/tony/.config/opencode/hooks/

Installer says:   hooksDest = path.join(targetDir, 'hooks')
                  targetDir = /home/tony/.config/opencode/gsd-core
                  → writes to /home/tony/.config/opencode/gsd-core/hooks/
